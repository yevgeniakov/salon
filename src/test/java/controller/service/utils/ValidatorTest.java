...
public class ValidatorTest {
	...
	public void testValidName() {
		Stream.of("Helen", "anna", "Іван", "ванек").forEach(name -> assertTrue(ValidatorUtil.isValidName(name)));
	}
	...
	public void testValidTimeslot() {
		Stream.of("0", "1", "5", "11", "14", "23").forEach(tm -> assertTrue(ValidatorUtil.isValidTimeslot(tm)));
	}
	...
	public void testValidRating() {
		Stream.of("1", "2", "3", "4", "5", "0").forEach(rat -> assertTrue(ValidatorUtil.isValidRating(rat)));
	}

	@Test
	public void testNotValidTel() {
		Stream.of(null, "", "458", "678541236", "+380254122336", "80684523696", "gjhh", "068521144", "099632kl78", " ",
				"04458796258").forEach(tel -> assertFalse(ValidatorUtil.isValidTel(tel)));
	}
	...
	public void testValidSortorder() {
		Stream.of("asc", "desc").forEach(param -> assertTrue(ValidatorUtil.isValidSortOrder(param)));
	}

	@Test
	public void testParseInt() {
		Stream.of(null, "", "tgfcv", "-89", "-5", "78.9").forEach(param -> {
			try {
