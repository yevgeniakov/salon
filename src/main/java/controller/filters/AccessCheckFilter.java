...
public class AccessCheckFilter implements Filter {
	...
	private static final String[] ClientAllowedURLs = { "/header.jsp", "/footer.jsp", "locale", "/index.jsp",
			"/error.jsp", "/my_info.jsp", "/master_list.jsp", "/master_schedule.jsp", "/create_appointment.jsp",
			"/leave_feedback.jsp", "/appointments_list.jsp", "/appointment_info.jsp", "/help.jsp", "/Controller",
			"/css/", "/js/", "/images" };
	private static final String[] MasterAllowedURLs = { "/header.jsp", "/footer.jsp", "locale", "/index.jsp",
			"/error.jsp", "/my_info.jsp", "/master_schedule", "/appointments_list.jsp", "/appointment_info.jsp",
			"/help.jsp", "/Controller", "/css/", "/js/", "/images" };
	private static final String[] GuestAllowedURLs = { "/header.jsp", "/footer.jsp", "locale", "/index.jsp",
			"/registration.jsp", "/login.jsp", "/error.jsp", "/master_list.jsp", "/master_info.jsp", "/help.jsp",
			"/Controller", "/css/", "/js/", "/images" };
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		logger.trace("isAdmin = " + isAdmin + ", isClient = " + isClient + ", isMaster = " + isMaster + ", isGuest = "
				+ isGuest);
		String destinationPage = "/error.jsp";
		if (isAdmin && !isAdminAllowed() || isClient && !isClientAllowed() || isMaster && !isMasterAllowed()
				|| isGuest && !isGuestAllowed()) {
