...
public class AppointmentManager {
	...
	public void setFeedbackForAppointmentandUpdateMaster(Appointment appointment, double rating, String feedback) throws Exception {
		Connection con = null;
	...
	public List<Appointment> findAppointmentsByConditions(LocalDate dateFrom, LocalDate dateTo, Integer master_id,
		...
		try {
			...
			appointments = dao.findByConditions(con, dateFrom, dateTo, master_id,
					user_id, service_id, isDone, isPaid, isRating);
