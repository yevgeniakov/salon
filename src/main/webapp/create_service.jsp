...
<div class="create-service">
	<h3>
		<fmt:message key="label.create_service" />
	</h3>
	<br>
	<form action="Controller" method=post>
		<strong><fmt:message key="label.name_of_service" /></strong> <br>
		<input class="form-control" name="name" required> <br> <strong><fmt:message
				key="label.service_info" /></strong> <br>
		<textarea class="form-control" rows="10" cols="60" name="info"
			required>
    </textarea>
