...
<div class="table-list">
		...
		<div class="container-fluid">
			<form action="Controller" name="formSearch" method="get">
				<div class="row">
					...
					<div class="col-sm">
						<select class="form-select" name="isdone"
							onchange="document.formSearch.submit();">
							<option value="null"
								<c:if test="${isDone == null}"> selected </c:if>><fmt:message
									key="option.all" /></option>
							<option value=true
					...
					<div class="col-sm">
						<select class="form-select" name="ispaid"
							onchange="document.formSearch.submit();">
							<option value="null"
								<c:if test="${isPaid == null}"> selected </c:if>><fmt:message
									key="option.all" /></option>
							<option value=true
					...
					<div class="col-sm">
						<select class="form-select" name="israting"
							onchange="document.formSearch.submit();">
							<option value="null"
				...
				<div class="row justify-content-end">
					...
					<div class="col-sm-1">
						<input class="form-control" name="itemsperpage"
							onchange="document.formSearch.submit();"
	...
	<br>
	<c:set var="master_id_param" value="null"></c:set>
	<c:set var="user_id_param" value="null"></c:set>
	<c:if test="${sessionScope.user.role != 'HAIRDRESSER'}">
